...
class GSN(nn.Module):
    """ 
    GSN class with variable architecture, implemented in PyTorch Geometric. Optionally includes batchnorm and dropout.
    """
    ...
    def __init__(self,
        ...
        for k in range(n_conv_layers):
            ...
            self.layers.append(GSNConv(MLP(architecture = arch(dim, hidden_dim, hidden_dim, mlp_n_hidden_layers),
...
class GSNConv(MessagePassing):

    def __init__(self, in_features, out_features, **kwargs):
        super(GSNConv, self).__init__(aggr='add', **kwargs)
